...
type AdminApp interface {
	...
	ListLLMUsageEvents(ctx context.Context, filter storage.LLMUsageEventFilter) ([]storage.LLMUsageEvent, error)
	SummarizeLLMUsage(ctx context.Context, filter storage.LLMUsageSummaryFilter) ([]storage.LLMUsageSummaryRow, error)
	ListTokenEstimatorCalibrations(ctx context.Context, filter storage.TokenEstimatorCalibrationFilter) ([]storage.TokenEstimatorCalibration, error)
	RefreshTokenEstimatorCalibrations(ctx context.Context, filter storage.TokenEstimatorCalibrationFilter) (int, error)
